...
class ImageRegistration:
    ...
    def affine_registration(self, profile):
        ...
        """
        if json == 1:
            affine_params_filename = os.path.join(os.getcwd(), '..', 'irreg', 'registration', 'schemas',
                                                  '1_affine_cg.json')
    ...
    def bspline_registration(self, profile):
        ...
        if json == 1:
            bspline_params_filename = os.path.join(os.getcwd(), '..', 'irreg', 'registration', 'schemas',
                                                   '3_bspline_lbfgs2.json')
